<template>
  <div class="q-pa-md">
    <q-list bordered padding>
      <q-item-label header>Configuracion inicial</q-item-label>

      <q-item clickable v-ripple>
        <q-item-section>
          <q-item-label>Dia en que finaliza el mes</q-item-label>
          <q-item-label caption> aqui esta el calendar </q-item-label>
        </q-item-section>
      </q-item>

      <q-item clickable v-ripple>
        <q-item-section>
          <q-item-label>Monto inicial mes</q-item-label>
          <q-item-label caption>
            aqui va el input con boton que establecera el monto incial del mes
          </q-item-label>
        </q-item-section>
      </q-item>
